    ...
    <>
      ...
      <div className="min-w-0 flex-1 overflow-x-hidden bg-gradient-to-b from-background via-secondary/60 to-chart-5/10 p-4 sm:p-6 lg:p-8">
        <header className="mb-8 w-full min-w-0">
          <h1 className="mt-0.5 text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Add action</h1>
        ...
        >
          <div className="relative border-b border-border/70 bg-card px-6 py-6 sm:px-10 sm:py-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-primary">New action</p>
                <p className="mt-1 text-xs text-muted-foreground">Fill in the required fields to define an action</p>
              </div>
            </div>
          </div>
