  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground antialiased lg:flex-row">
      ...
      >
        ...
        <div className="pointer-events-none absolute -right-24 -top-16 h-[22rem] w-[22rem] rounded-full bg-orange-400/30 blur-3xl" aria-hidden="true" />
        <div className="pointer-events-none absolute -bottom-32 left-1/4 h-72 w-72 rounded-full bg-orange-500/20 blur-3xl" aria-hidden="true" />

        <div className="relative z-10 flex flex-1 flex-col justify-center">
          <p className="inline-flex w-fit items-center rounded-full bg-orange-400/15 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.14em] text-orange-200 ring-1 ring-orange-400/25">
            Operational Plan
          </p>
          <h1 className="mt-6 max-w-md text-3xl font-bold leading-tight tracking-tight text-white sm:text-4xl">
        ...
        <p className="relative z-10 mt-10 text-xs leading-relaxed text-slate-500 lg:mt-0">
      ...
      <main className="relative flex w-full min-w-0 flex-col items-center justify-center overflow-x-hidden px-4 py-10 sm:px-6 lg:w-[40%] lg:px-7 lg:py-16">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-gray-100 via-orange-50/40 to-gray-100" aria-hidden="true" />
          ...
          <div className="rounded-3xl bg-card p-8 shadow-sm ring-1 ring-border/60 sm:p-10 lg:p-10">
            ...
            <form className="space-y-5">
              ...
              <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Link
                  to="#"
                  className="text-sm font-semibold text-orange-500 transition hover:text-orange-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/40 focus-visible:ring-offset-2"
                >
                  Forgot password?
                </Link>
              </div>

              <Button type="submit" className="mt-2 h-11 w-full rounded-2xl bg-orange-400 text-white hover:bg-orange-500">
                Sign in
              </Button>
            </form>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2">
              <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-100">Planning</Badge>
              <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100">Strategy</Badge>
              <Badge className="bg-yellow-100 text-yellow-800 hover:bg-yellow-100">Operations</Badge>
              <Badge className="bg-amber-100 text-amber-900 hover:bg-amber-100">Auditor review</Badge>
            </div>
          </div>
        </div>
      </main>
