        ...
        operationalObjectives: [
          {
            ...
            proposedByDepartment: "Deanship of Student Affairs",
            proposedBySubUnit: "Academic Counseling Office",
          },
        ],
      },
      {
                  ...
                  <div className="flex flex-col gap-4 border-b border-border pb-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
                    ...
                    {activeBeneficiary.subs?.length ? (
                      <div className="w-full shrink-0 sm:w-auto sm:min-w-[13rem]">
                        <label htmlFor="beneficiary-sub" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                          Sub-section
                        </label>
                        <Select
                  ...
                  <div className="relative mt-6">
                    ...
                    {activeSub ? (
                      ...
                      <div className="rounded-2xl border border-border/60 bg-card/90 p-5 shadow-sm ring-1 ring-white/60 backdrop-blur-sm sm:p-6">
                        <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">{activeBeneficiary.body}</p>
                      </div>
                    )}
                  </div>
