          ...
          <div className="mt-2 flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                Partnership alignment and accountable institutional engagement
              </p>
            </div>
          </div>
        </header>
        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-4 bg-sidebar px-5 py-4 sm:px-6">
            ...
            <div className="relative">
              <h2 id="stakeholders-glance-heading" className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary">
                Overview
              </h2>
              <p className="mt-1 text-sm font-semibold text-sidebar-foreground">Stakeholder layer · 2026 operational plan</p>
            </div>
          </div>
          ...
          >
            <div className="border-b border-border bg-gradient-to-r from-muted/90 via-card to-primary/[0.06] px-6 py-4 sm:px-8 sm:py-5">
              ...
              <p className="mt-1.5 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                Choose <span className="font-semibold text-foreground">S1</span>. Each stakeholder group includes sub-sections, indicator detail, and linked operational objectives.
              </p>
            </div>
                  ...
                  <div className="flex flex-col gap-4 border-b border-primary/25 pb-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
                    ...
                    {activeStakeholder.subs?.length ? (
                      <div className="w-full shrink-0 sm:w-auto sm:min-w-[13rem]">
                        ...
                        <Select
                          value={activeStakeholder.subs[currentSubIndex]?.label ?? ""}
                          onValueChange={(label) => {
                            const idx = activeStakeholder.subs?.findIndex((s) => s.label === label) ?? -1
                        ...
                        >
                          ...
                          <SelectContent>
                            {activeStakeholder.subs.map((sub) => (
